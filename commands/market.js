...
module.exports.run = async (client, msg, args) => {
 ...
 // gitu // why not reply // lebih enak send daripada reply :v
  ...
  if (!args[0]) {
    ...
    .setColor("GREEN")
    .setFooter(`Athuko's | Pickaxe Market`)
    ...
    .setDescription(`
Use **at!market buy [no]** to buy Pickaxe
Example » **at!market buy 1**

1 | <:stoneee:543321768807366666> Stone Pickaxe  »  **💳 1000$**
...
`);
  ...
  if(crafty.match("buy 1")) {
    ...
    msg.channel.send(`<:stoneee:543321768807366666> | Congrats, You buy <:stoneee:543321768807366666> for **💳 1000$**`)
    }
