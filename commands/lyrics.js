...
module.exports = {
    ...
    execute(client, msg, args) {
        ...
        if(!lyrics) return msg.channel.send("You didn't provide the name of the song!");
        ...
        if (typeof body.author == 'undefined') return msg.channel.send("Can't find lyrics for the song!")
