...
exports.run = async (client, message, args, color, prefix) => {
    if(message.author.id !== "577323427434594313" && message.author.id !== "577323427434594313") return message.channel.send("You cannot use this command because, you are not a developer.")
